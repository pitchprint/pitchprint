...
class ControllerExtensionModulePitchprint extends Controller {
	...
	public function index() {   
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/module/pitchprint', 'token=' . $this->session->data['token'], true),
			'separator' => ' :: '
		);
		
		$data['action'] = $this->url->link('extension/module/pitchprint', 'token=' . $this->session->data['token'], true);
	...
	public function install() {
		...
		$this->model_extension_pitchprint_process->install();
	...
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/pitchprint')) {
